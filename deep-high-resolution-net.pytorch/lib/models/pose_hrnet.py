...
class InceptionBlockV2(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1_tower2 = conv1x1(inplanes, int(planes/self.filter_output), stride=1)
        self.bn1_tower2 = nn.BatchNorm2d(int(planes/self.filter_output), momentum=BN_MOMENTUM)
        self.conv13_tower2 = conv1x3(int(planes/self.filter_output), int(planes/self.filter_output), stride=1)
        self.bn2_tower2 = nn.BatchNorm2d(int(planes/self.filter_output), momentum=BN_MOMENTUM)
        self.conv31_tower2 = conv3x1(int(planes/self.filter_output), int(planes/self.filter_output), stride)
        self.bn3_tower2 = nn.BatchNorm2d(int(planes/self.filter_output), momentum=BN_MOMENTUM)
        self.conv1_tower3 = conv1x1(inplanes, int(planes/self.filter_output), stride=1)
        self.bn1_tower3 = nn.BatchNorm2d(int(planes/self.filter_output), momentum=BN_MOMENTUM)
        self.conv13_first_tower2 = conv1x3(int(planes/self.filter_output), int(planes/self.filter_output), stride=1)
        self.bn2_tower3 = nn.BatchNorm2d(int(planes/self.filter_output), momentum=BN_MOMENTUM)
        self.conv31_first_tower2 = conv3x1(int(planes/self.filter_output), int(planes/self.filter_output), stride=1)
        self.bn3_tower3 = nn.BatchNorm2d(int(planes/self.filter_output), momentum=BN_MOMENTUM)
        self.conv13_second_tower2 = conv1x3(int(planes/self.filter_output), int(planes/self.filter_output), stride=1)
        self.bn4_tower3 = nn.BatchNorm2d(int(planes/self.filter_output), momentum=BN_MOMENTUM)
        self.conv31_second_tower2 = conv3x1(int(planes/self.filter_output), int(planes/self.filter_output), stride)
        self.bn5_tower3 = nn.BatchNorm2d(int(planes/self.filter_output), momentum=BN_MOMENTUM)
        self.max_pool_tower4 = nn.MaxPool2d(3, stride=1, padding=1)
        self.conv1_tower4 = conv1x1(inplanes, int(planes/self.filter_output), stride)
        self.downsample = downsample
        self.stride = stride
    def forward(self, x):
        ...
        tower_2 = self.bn1_tower2(tower_2)
        tower_2 = self.relu(tower_2)
        tower_2 = self.conv13_tower2(tower_2)
        tower_2 = self.bn2_tower2(tower_2)
        tower_2 = self.relu(tower_2)
        tower_2 = self.conv31_tower2(tower_2)
        tower_2 = self.bn3_tower2(tower_2)
        tower_2 = self.relu(tower_2)
        tower_3 = self.conv1_tower3(x)
        tower_3 = self.bn1_tower3(tower_3)
        tower_3 = self.relu(tower_3)
        tower_3 = self.conv13_first_tower2(tower_3)
        tower_3 = self.bn2_tower3(tower_3)
        tower_3 = self.relu(tower_3)
        tower_3 = self.conv31_first_tower2(tower_3)
        tower_3 = self.bn3_tower3(tower_3)
        tower_3 = self.relu(tower_3)
        tower_3 = self.conv13_second_tower2(tower_3)
        tower_3 = self.bn4_tower3(tower_3)
        tower_3 = self.relu(tower_3)
        tower_3 = self.conv31_second_tower2(tower_3)
        tower_3 = self.bn5_tower3(tower_3)
        tower_3 = self.relu(tower_3)
        tower_3 = self.relu(tower_3)
        tower_4 = self.max_pool_tower4(x)
        tower_4 = self.conv1_tower4(tower_4)
...
blocks_dict = {
    ...
    'InceptionBlockV2': InceptionBlockV2
}
...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        # self.layer1 = self._make_layer(InceptionBlock, 64, 4)

        self.stage2_cfg = cfg['MODEL']['EXTRA']['STAGE2']
        # self.stage2_cfg['BLOCK'] = 'InceptionBlockV2'
        ...
        # self.stage3_cfg["BLOCK"] = "InceptionBlockV2"
