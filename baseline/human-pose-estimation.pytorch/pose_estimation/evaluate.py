...
from core.function import evaluate, validate
...
def main():
    ...
    valid_dataset = eval('dataset.'+config.DATASET.DATASET)(
        ...
        is_eval=True,
        eval_image='/home/shared/deepcoaching/custom_data/am3.jpg' # NOTE: Change this to run on arbitrary image
    )
    ...
    evaluate(config, valid_loader, valid_dataset, model, final_output_dir)
